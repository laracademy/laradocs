...
@section('content')
    <h1>Managing Version: {{ $version->name }} <span class="small">(<a href="{{ route('administration.versions.edit', $version) }}">edit</a>)</span></h1>
    <p class="text-muted">
        ...
        <div class="col">
            <div class="card">
                <div class="card-block">
                    ...
                    <a href="{{ route('administration.documentation.version', $version) }}" class="btn btn-primary">View Associated Files</a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card">
                <div class="card-block">
                    ...
                    <a href="{{ route('administration.import.github', $version) }}" class="btn btn-primary">Import from Github</a>
                </div>
            </div>
        </div>
